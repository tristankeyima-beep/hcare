...
对外表达 AI 健康处方能力时，少说“智能生成”，多强调系统级 Agent 能力：

- 上下文感知：持续理解患者档案、指标、饮食运动、随访和既往方案。
- 任务编排：把健康方案制定拆解为风险识别、策略规划、内容生成、审阅优化等步骤。
- 可观测推理：让健管师看到 AI 正在如何拆解问题、形成判断和组织方案。
- Human-in-the-loop：健管师参与确认、追问、修订和最终发布，不是被 AI 替代。
- 持续优化：方案生成后仍可基于患者变化和健管师反馈继续迭代。
- 健康处方引擎：把单次内容生成升级为贯穿患者管理全流程的智能底座。
