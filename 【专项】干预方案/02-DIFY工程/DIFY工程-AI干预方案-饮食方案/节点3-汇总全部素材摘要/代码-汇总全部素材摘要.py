...
def main(
    ...
    diet_execution_summary=None,
    safety_energy_summary=None,
    ...
    **kwargs
    ...
    bundle = {
        ...
        "diet_execution_summary": _parse_summary_text(diet_execution_summary),
        "safety_energy_summary": _parse_summary_text(safety_energy_summary)
    }
