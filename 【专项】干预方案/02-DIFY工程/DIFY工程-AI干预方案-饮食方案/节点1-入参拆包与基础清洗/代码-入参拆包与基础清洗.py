...
def main(
    ...
    **kwargs
    ...
    diet_records = _limit_records(_ensure_list(diet_records_last_1y), 120)
    exercise_records = _limit_records(_ensure_list(exercise_records_last_1y), 80)
    ...
    normalized_plan_type = (plan_type or "diet").strip().lower()
